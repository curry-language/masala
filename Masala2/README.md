...
This Curry package contains the implementation of Masala,
a web-based system to upload and publish software packages
written in the declarative multi-paradigm language Curry.

The initial version of this implementation has been generated
with the web framework Spicey so that most of the following notes
are generated by Spicey.
